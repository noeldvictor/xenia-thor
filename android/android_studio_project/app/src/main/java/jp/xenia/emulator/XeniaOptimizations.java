    ...
    static {
        ...
        list.add(new Optimization(
                ...
                "The Adreno 740 supports hardware Variable Rate Shading "
                        ...
                        + "2026-06-20: -7.5% GPU frame time on the Burnout race (46.0->42.6ms, "
                        + "matched A/B, visually clean); the fps gain lands on GPU-BOUND scenes "
                        + "(e.g. Blue Dragon's foliage field), and it's a GPU-time/power saving "
