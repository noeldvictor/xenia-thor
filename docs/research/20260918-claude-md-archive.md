...
This file holds the full text of CLAUDE.md as it was on 2026-09-18, before the split.
The new CLAUDE.md is short. It points here by section title.
To find a section, search this file for the title, or use the index file `20260918-claude-md-archive-index.md`.
Do not edit this file. Put new findings in a dated research note under `docs/research/`.
