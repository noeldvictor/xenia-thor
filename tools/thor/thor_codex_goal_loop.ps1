...
switch ($Mode) {
    ...
    "EnableBlueDragonFullSpeed" {
        $prompt = (
            ...
            "Latest evidence: docs/research/20260524-044223-822877bc-span-reduction-audit.md. The new tools/thor/thor_hir_span_reduction_audit.ps1 combines filtered HIR, block-body rows, and separate call-edge rows so inclusive parent time is not mistaken for local generated-code work. For 82287788 span 822877BC-82287B38, block body was 1173620 ticks, but child edge 82287788 -> 821CE028 accounted for 1147798 ticks over 340310 calls, leaving only 25822 approximate parent-exclusive ticks (2.2%). The parent dump still shows large CR/state/vector traffic, but do not patch local 822877BC-82287B38 generated code first. Next target is a route-stabilized filtered HIR plus delayed body/block-time capture for 821CE028, keeping 82282490 and 82287788 in the body-time filter as comparators. Keep CR compare/barrier fusion, CR-store elision, broad VMX-dot, stale 822824F0, broad GPR caches, and exact stvewx lane-fold A/B closed unless new exclusive-body evidence reopens them. Previous evidence: docs/research/20260524-042555-82287788-focused-callee-split.md. Two captures scratch/thor-debug/20260524-041413-* and scratch/thor-debug/20260524-042031-* reached the visible opening sky/wing route with clean fatal-marker searches on APK SHA A4CB9C0E8F4CBB63EB09F3DA38640BEA5410DFE5916A155627C18F3B90C39BD8. The lower-noise call-edge split keeps 82282490 as the main wall at body_ticks_total=31584286 and puts 82287788 secondary at body_ticks_total=3659269, ticks_per_entry=5, code_size=35380. The only meaningful dynamic child edge is 82287788 -> 821CE028 with body_ticks_total=1147798, calls_total=340310, ticks_per_call=3. Older evidence: docs/research/20260524-040404-blue-dragon-stvewx-lane-fastpath.md. The default-off A64 EXTRACT_I32 fastpath for only 82282580 -> lane 0 and 82282584 -> lane 1 is route-clean and audited but did not prove speed; keep arm64_blue_dragon_stvewx_stack_lane_fastpath and audit default-off and do not repeat that exact A/B unchanged. Previous lane provenance remains docs/research/20260524-034103-8228252c-stvewx-lane-provenance.md. Previous codegen audit remains docs/research/20260524-033116-8228252c-a64-codegen-audit.md: the exact slice has body total 8530471, child edge 8228252C -> 82287788 body 5653971, approximate exclusive local work 2876500, and generated-code shape dominated by store_context:27, load_context:14, extract:9, splat:6, stvewx:3, and vmaddfp:3. Previous block-slice evidence remains docs/research/20260524-032005-82282490-dynamic-block-slice-report.md. Previous recursive-edge evidence remains docs/research/20260524-031017-82282490-exclusive-callee-attribution.md: direct-call edges account for 84.08% of final 82282490 body ticks, and 822825E0 -> 82282490 is mostly callee-body work, not generic call/prolog overhead. Previous entry/exit evidence remains docs/research/20260524-025544-a64-entry-exit-profiler.md: generated prolog/epilog/stackpoint overhead is tiny, so keep a64_enable_host_guest_stack_synchronization default true and treat stack-sync-off as code-size evidence only. " +
