...
switch ($Mode) {
    ...
    "EnableBlueDragonFullSpeed" {
        $prompt = (
            ...
            "Current priority, superseding the older chronology below: docs/research/20260525-175612-edge-variant-pc-attribution.md records a FullDeploy plus route-clean Thor retry capture for default-off arm64_blue_dragon_edge_variant_audit per-PC counters. Working tree based on commit 42be319ef, APK SHA FC9CE27AA7B7040CC741417B8B225B351A9624F43BCA444B4CA02480D57068E8, reached the visible opening sky / dragon-wing route with clean fatal-marker search. Exact edge 82282490:82282598 -> 82287788 remains behavior-neutral with eligible_calls=675279, normal_fallbacks=675279, payload_materializations=0, active_f1_reads=2015839, and active_call_kills=1693099. Active f[1] read sites were 82287798=675279, 82287828=333248, 82287CF8=332673, 82287D10=332673, 82287D8C=332673, 82287F1C=9293, and 82287A1C/82287A2C/82287AA4/82287EA8=0. Active kill sites were 8228778C=675279, 82287854=333248, 82287EDC=665986, 82287EE4=9293, 82288220=9293, and 82287ED4=0. Do not materialize payloads or run a quiet speed A/B from this audit-only patch. Next useful slice is source-backed f[1] kill-taxonomy split for the same edge: helper-preserved vs child/unknown-call kills, keeping fpscr out of the read-only f[1] lane. Final evidence remains CPU/JIT-heavy: 82282490=34275577, 82281D28=7553858, 82287788=4474801, Main Thread 100%, GPU Commands 11.5%; do not pivot to broad Vulkan work. Hardware acceleration menu docs/research/20260525-171305-thor-hardware-acceleration-menu.md says use Thor NEON/dot/I8MM/CRC/LSE only with opcode/source/counter proof and move only Xenos-like bulk graphics work to Adreno after a measured graphics-work audit finds CPU-side graphics cost. " +
