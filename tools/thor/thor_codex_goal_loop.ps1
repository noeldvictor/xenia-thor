...
switch ($Mode) {
    ...
    "EnableBlueDragonFullSpeed" {
        $prompt = (
            ...
            "Latest evidence: docs/research/20260524-025544-a64-entry-exit-profiler.md. Recursive 822825E0 -> 82282490 remains the opening-route wall, but route-clean capture scratch/thor-debug/20260524-025000-* proves generated prolog/epilog/stackpoint overhead is tiny: 82282490 entry/exit was 273393 ticks over 186010 entries, or 1.47 ticks/call and 0.93% of body total; 82281D28 was 1.547 ticks/call and 1.56% of body total. Keep a64_enable_host_guest_stack_synchronization default true and treat stack-sync-off as code-size evidence only. Do not run another unchanged stack-sync or entry/exit A/B; next focus exclusive attribution inside the 82282490 body/recursive child path, or fresh body-backed state-traffic reduction. " +
