...
switch ($Mode) {
    ...
    "EnableBlueDragonFullSpeed" {
        $prompt = (
            ...
            "Latest evidence: docs/research/20260524-005156-82486178-vmx-copy-loop-fastpath.md. The default-off arm64_blue_dragon_vmx_copy_loop_fastpath experiment for 82486178:8248627C is route-clean but did not prove speed. Fastpath-on scratch/thor-debug/20260524-004420-* and same-APK fastpath-off scratch/thor-debug/20260524-004802-* both reached the visible Blue Dragon sky/wing opening route with clean fatal-marker searches, but the control had lower final 82486178 and 82490030 body-time totals. Keep arm64_blue_dragon_vmx_copy_loop_fastpath default-off and do not repeat that exact A/B unchanged. " +
            ...
            "Next slice should use fresh delayed body/HIR/block evidence on the remaining 82490030 children, especially 82485DD8 and 82486018, before another generated-code shortcut. Keep call-edge/profiling cvars default-off outside targeted captures."
        )
