...
function New-BlueDragonFullSpeedPrompt {
    $parts = @(
        ...
        "Current decision notes: docs/research/20260525-203000-continual-harness-plan-reset.md and docs/research/20260525-203900-a64-mature-gap-reset-rerank.md. Use them as the active plan if present.",
        ...
        "Preferred next lanes are structural and currently ranked: pre-RA/register-allocation or guest-state-cache design, broad VMX128-to-NEON opcode-family audit, helper ABI/block-linking audit, fastmem only with counter evidence, and GPU offload only when counters justify it.",
