...
switch ($Mode) {
    ...
    "EnableBlueDragonFullSpeed" {
        $prompt = (
            ...
            "Latest evidence: docs/research/20260524-045602-821ce028-focused-capture.md. Capture scratch/thor-debug/20260524-045022-* followed the 82287788 -> 821CE028 child edge, reached the visible opening sky/wing route, and had a clean fatal-marker search on APK SHA A4CB9C0E8F4CBB63EB09F3DA38640BEA5410DFE5916A155627C18F3B90C39BD8. Final body rows were 82282490=37190996, 82281D28=7446911, 82287788=4992080, and 821CE028=2523574. 821CE028 emitted OptHIR and its top local block 821CE048-821CE1CC is fully local at body_total=607573 with vmsum4fp128*:6, vcmpgefp.:6, vcmpgtfp.:6, vslw:6, vxor:6, mfcr:12, and rlwinm:13. Do not patch 821CE028 immediately: CR store/barrier and broad VMX-dot lanes remain rejected, and the only safe-looking lane is a narrow offline r10 state-traffic audit. Prefer the larger next target: route-stabilized filtered HIR plus delayed body/block-time capture for 82281D28, keeping 82282490, 82287788, and 821CE028 in the body-time filter as comparators. Previous evidence: docs/research/20260524-044223-822877bc-span-reduction-audit.md. For 82287788 span 822877BC-82287B38, block body was 1173620 ticks, but child edge 82287788 -> 821CE028 accounted for 1147798 ticks over 340310 calls, leaving only 25822 approximate parent-exclusive ticks (2.2%), so do not patch local 822877BC-82287B38 generated code first. Older evidence: docs/research/20260524-042555-82287788-focused-callee-split.md. Two captures scratch/thor-debug/20260524-041413-* and scratch/thor-debug/20260524-042031-* reached the visible opening sky/wing route with clean fatal-marker searches on the same APK SHA. The lower-noise call-edge split kept 82282490 as the main wall at body_ticks_total=31584286 and put 82287788 secondary at body_ticks_total=3659269. Older evidence: docs/research/20260524-040404-blue-dragon-stvewx-lane-fastpath.md. The default-off A64 EXTRACT_I32 fastpath for only 82282580 -> lane 0 and 82282584 -> lane 1 is route-clean and audited but did not prove speed; keep arm64_blue_dragon_stvewx_stack_lane_fastpath and audit default-off and do not repeat that exact A/B unchanged. Previous lane provenance remains docs/research/20260524-034103-8228252c-stvewx-lane-provenance.md. Previous recursive-edge evidence remains docs/research/20260524-031017-82282490-exclusive-callee-attribution.md and previous entry/exit evidence remains docs/research/20260524-025544-a64-entry-exit-profiler.md: generated prolog/epilog/stackpoint overhead is tiny, so keep a64_enable_host_guest_stack_synchronization default true and treat stack-sync-off as code-size evidence only. " +
