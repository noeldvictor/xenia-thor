...
function New-BlueDragonFullSpeedPrompt {
    $parts = @(
        ...
        "Current decision notes: docs/research/20260525-203000-continual-harness-plan-reset.md, docs/research/20260525-203900-a64-mature-gap-reset-rerank.md, docs/research/20260526-012000-vmx128-route-stabilized-counters.md, docs/research/20260526-030200-82281d28-block-map-capture.md, docs/research/20260526-032000-82281d28-call-setup-audit.md, docs/research/20260526-033000-guest-call-arg-handoff-audit.md, docs/research/20260526-034500-guest-call-hir-coverage-capture.md, docs/research/20260526-040500-a64-guest-call-fast-entry-feasibility.md, docs/research/20260526-041500-a64-guest-call-fast-entry-audit-skeleton.md, docs/research/20260526-043900-a64-guest-call-fast-entry-audit-capture.md, docs/research/20260526-045000-guest-call-callee-aware-audit.md, and docs/research/20260526-051000-a64-guest-call-fast-entry-target-rows.md. Use them as the active plan if present.",
        "Closed lanes: do not repeat f1/edge-payload behavior, stvewx, three-PC MUL_ADD_V128, fpscr, pre/post-promotion r1/r11, local-only 822824F0, broad Vulkan work, PACK/UNPACK VMX128 behavior, broad PERMUTE/LOAD_VECTOR_SHL/SHR behavior, unchanged HIR mapper captures, ordinal-fallback HIR behavior, local 82281D28:8228233C-82282370 store elision, one-off 826BF770 caller inlining, unchanged call/setup audits, unchanged 0x82281D28 fast-entry summary captures, or any fast-entry patch that replaces A64Function::machine_code or the global indirection slot. The edge-payload lifetime audit found segments_survived_no_kill=0 and f1_reads_before_kill=0. PACK/UNPACK route-volume found PACK absent and UNPACK zero weighted hot-block volume. The 20260526 VMX128 route counters found current vector volume either in closed local stvewx/vmaddfp shapes or smaller non-dominant 82287788 blocks. The 82281D28 call/setup audit found all r3-r10/lr stores live into callees and strict local promotion has zero safe wins. The callee-aware guest-call audit found real offline live-in volume for 82281D28, with callee_first_load_stores=247 and body_weighted_live_in_fields=690421033, but behavior remains blocked because the runtime compile audit still has callee_first_use_known=0, dirty_flush_points=268, and flush_context_barrier=260. The target-row patch adds counter-only per-target runtime rows; it is not speed proof and changes no generated behavior.",
        ...
        "Preferred next lanes are structural and currently ranked: FullDeploy and run a route-clean 0x82281D28 fast-entry target-row capture with the existing arm64_guest_call_fast_entry_audit cvars, then join target rows with the offline callee-aware HIR audit. Close the fast-entry behavior lane if rows do not show broad known first-use traffic with manageable flush pressure. Do not run a quiet speed A/B from counter-only evidence. Fallback lanes: guest-state cache only if it avoids closed r1/r11/f1/fpscr/barrier lanes; helper/block-linking only with a reusable static rule; fastmem only with counter evidence; GPU offload only when counters justify it. Large HIR captures should use file-backed output or adb -s c3ca0370 logcat -G 64M first. Do not use -AllowOrdinalFallback for behavior decisions.",
