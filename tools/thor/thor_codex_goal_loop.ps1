...
switch ($Mode) {
    ...
    "EnableBlueDragonFullSpeed" {
        $prompt = (
            ...
            "Current priority, superseding the older chronology below: docs/research/20260525-173225-edge-variant-payload-scope-audit.md records a FullDeploy plus route-clean Thor capture for a behavior-neutral caller-local payload-scope marker in default-off arm64_blue_dragon_edge_variant_audit. Working tree based on commit ef0521239, APK SHA 12E4BC4F69BA1D0C4A4A249F64C74BD81FB802569B46122644C9242A57DA8CB1, reached the visible opening sky / dragon-wing route with clean fatal-marker search. Exact edge 82282490:82282598 -> 82287788 now reports eligible_calls=687023, normal_fallbacks=687023, payload_materializations=0, marker_sets=687023, marker_clears=687023, active_f1_reads=2050899, inactive_f1_reads=3250, and active_call_kills=1722545. Treat this as storage-boundary proof, not speed proof: normal_fallback_share=100.00%, active_f1_reads_per_call=2.99, and active_call_kills_per_call=2.51. Do not materialize payloads or run a quiet speed A/B from this audit-only patch. Next useful slice is per-PC active f[1] read / kill-window attribution for the same marker, or broader 82282490 / 82287788 state-roundtrip design using this marker as safe caller-local scope proof. Previous residual register-cache capture docs/research/20260525-170307-arm64-register-cache-residual-audit-capture.md closes stale r1/r11 clean-load/dirty-cache/store-elision behavior lanes. Final evidence remains CPU/JIT-heavy: 82282490=34497956, 82281D28=7587167, 82287788=4153275, Main Thread 96.2%, GPU Commands 7.4%; do not pivot to broad Vulkan work. Hardware acceleration menu docs/research/20260525-171305-thor-hardware-acceleration-menu.md says use Thor NEON/dot/I8MM/CRC/LSE only with opcode/source/counter proof and move only Xenos-like bulk graphics work to Adreno after a measured graphics-work audit finds CPU-side graphics cost. " +
