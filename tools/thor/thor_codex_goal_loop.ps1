...
switch ($Mode) {
    ...
    "EnableBlueDragonFullSpeed" {
        $prompt = (
            ...
            "Current priority, superseding the older chronology below: docs/research/20260525-162250-arm64-guest-state-register-cache-residual-audit.md implements default-off arm64_guest_state_register_cache_residual_audit plus arm64_guest_state_register_cache_residual_audit_function, Android forwarding, and Thor flags -Arm64GuestStateRegisterCacheResidualAudit / -Arm64GuestStateRegisterCacheResidualAuditFunction. It reuses the r1/r11 guest-state register-cache counters after ContextPromotionPass::PromoteBlock and DSE, with payload_materializations_allowed=0 behavior_changed=0. NativeCore and ApkShell passed. Next useful slice is FullDeploy plus a route-clean Thor residual audit capture for 0x82282490: use -Arm64GuestStateRegisterCacheResidualAudit true -Arm64GuestStateRegisterCacheResidualAuditFunction 0x82282490 with delayed body-time comparators 82282490,82281D28,82287788. Do not patch generated behavior or run a quiet speed A/B until the residual row proves material post-promotion r1/r11 traffic. Source gate docs/research/20260525-161334-r1-clean-load-source-gate.md still applies: do not implement the stale same-block r1 clean-load prototype from pre-promotion counters. Final evidence remains CPU/JIT-heavy: 82282490=31080764, 82281D28=7471709, 82287788=3379246, Main Thread 100%, GPU Commands 7.6%; do not pivot to broad Vulkan work. " +
