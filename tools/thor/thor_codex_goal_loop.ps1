...
switch ($Mode) {
    ...
    "EnableBlueDragonFullSpeed" {
        $prompt = (
            ...
            "Latest evidence: docs/research/20260524-033116-8228252c-a64-codegen-audit.md. The new tools/thor/thor_hir_a64_codegen_audit.ps1 audits the exact 8228252C-822825C4 slice: body total 8530471, child edge 8228252C -> 82287788 body 5653971, approximate exclusive local work 2876500, and generated-code shape dominated by store_context:27, load_context:14, extract:9, splat:6, stvewx:3, and vmaddfp:3. Next prove stack-lane provenance for stvewx PCs 82282580, 82282584, and 82282588, or make a default-off function/block-gated stvewx lane-folding probe only for the two apparent r1+constant stores with correctness logging. Keep broad 822824F0 vector peepholes stale unless fresh body-backed evidence reopens them. Previous block-slice evidence remains docs/research/20260524-032005-82282490-dynamic-block-slice-report.md. Previous recursive-edge evidence remains docs/research/20260524-031017-82282490-exclusive-callee-attribution.md: direct-call edges account for 84.08% of final 82282490 body ticks, and 822825E0 -> 82282490 is mostly callee-body work, not generic call/prolog overhead. Previous entry/exit evidence remains docs/research/20260524-025544-a64-entry-exit-profiler.md: generated prolog/epilog/stackpoint overhead is tiny, so keep a64_enable_host_guest_stack_synchronization default true and treat stack-sync-off as code-size evidence only. " +
