...
function New-AndroidUsabilityPrompt {
    $parts = @(
        ...
        "First read AGENTS.md, .agents/skills/xenia-windows-powershell-command-hygiene/SKILL.md, the AYN Thor/Xenia debug skill, docs/worklogs/20260527.md or newer, docs/research/20260527-144000-android-game-launch-crash-and-controller-mapping.md, docs/research/20260527-151500-android-ingame-menu-overlay-controller-start.md, docs/research/20260527-152100-android-osd-exit-to-menu.md, docs/research/20260527-164500-android-internal-resolution-and-sylpheed-480p.md, docs/research/20260527-170000-android-launch-status-ui.md, docs/research/20260527-171500-android-recent-games-status-list.md, and scratch/thor-debug/codex-goal-loop.json if present.",
        ...
        "Known Android usability evidence: docs/research/20260527-144000-android-game-launch-crash-and-controller-mapping.md fixed document-URI launch target resolution, MAP_FAILED detection, two assertion-abort classes, and visual controller remapping. docs/research/20260527-151500-android-ingame-menu-overlay-controller-start.md added fullscreen, FPS OSD, Back-as-menu, controller help, and Thor Menu-to-Xbox Select mapping. docs/research/20260527-152100-android-osd-exit-to-menu.md added Exit to menu with LauncherActivity in the separate :launcher process. docs/research/20260527-164500-android-internal-resolution-and-sylpheed-480p.md added 480p/720p/1080p guest video-mode settings and fixed the Project Sylpheed intro fit symptom at 480p, but its physical-heap / guest-exception compatibility crash remains. docs/research/20260527-170000-android-launch-status-ui.md added launcher last-run status for likely crash/forced-close versus intentional Exit to menu. docs/research/20260527-171500-android-recent-games-status-list.md added a recent-games list with per-title status rows and clickable relaunch.",
        "Preferred next product slice: feed richer host-side crash/stall classifications into recent-game rows, or run a focused Project Sylpheed physical-heap / RtlRaiseException compatibility audit. Do not rerun old Blue Dragon speed captures from this loop.",
