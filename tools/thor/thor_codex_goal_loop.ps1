...
function New-BlueDragonFullSpeedPrompt {
    $parts = @(
        ...
        "Current decision notes: docs/research/20260525-203000-continual-harness-plan-reset.md, docs/research/20260525-203900-a64-mature-gap-reset-rerank.md, docs/research/20260525-233000-vmx128-route-volume-audit.md, and docs/research/20260525-235500-a64-register-allocation-audit-skeleton.md. Use them as the active plan if present.",
        ...
        "Preferred next lanes are structural and currently ranked: FullDeploy plus a route-clean 0x82282490 arm64_register_allocation_audit capture, then either allocator-pressure analysis if spill pressure is material, current PERMUTE/LOAD_VECTOR_SHL/SHR route counters before VMX128 behavior, helper ABI/block-linking audit, fastmem only with counter evidence, and GPU offload only when counters justify it.",
