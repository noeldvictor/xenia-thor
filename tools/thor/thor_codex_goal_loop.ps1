...
switch ($Mode) {
    ...
    "EnableBlueDragonFullSpeed" {
        $prompt = (
            ...
            "Latest f[1] carrier runtime audit: docs/research/20260524-104145-blue-dragon-f1-carrier-runtime-audit.md. The default-off arm64_blue_dragon_f1_carrier_audit probe is implemented and route-clean. NativeCore and FullDeploy passed. Capture scratch/thor-debug/20260524-103438-* reached visible opening sky/dragon-wing with clean fatal-marker search on APK SHA 514C6A8C0C14820BFE0ED48CF280D00371B30602AEEE5CD86AE06A82E05D139F. Final counters were total=755910/2159587, helper_preserved=379058/1081707, and child_preserved=376852/1077880. This proves the 82287788 f[1] replacement opportunity is dynamically real, but it is not speed proof because the run used generated-code atomic counters and 82287788 remains high-entry but cheap at body_ticks_total=3578711 and ticks_per_entry=5. Keep arm64_blue_dragon_f1_carrier_audit default-off and out of presets. Next continuation should implement a default-off 82287788 f[1] carrier replacement probe for offset 296, preserving only across __savegprlr_28, __restgprlr_28, and direct calls to 0x821CE028, with explicit kills for unknown calls, indirect calls, exits, exceptions, and overlapping stores. Do not include fpscr or broad FPR caching. " +
