...
function New-BlueDragonFullSpeedPrompt {
    $parts = @(
        ...
        "Current decision notes: docs/research/20260525-203000-continual-harness-plan-reset.md, docs/research/20260525-203900-a64-mature-gap-reset-rerank.md, docs/research/20260526-012000-vmx128-route-stabilized-counters.md, docs/research/20260526-030200-82281d28-block-map-capture.md, docs/research/20260526-032000-82281d28-call-setup-audit.md, docs/research/20260526-033000-guest-call-arg-handoff-audit.md, docs/research/20260526-034500-guest-call-hir-coverage-capture.md, docs/research/20260526-040500-a64-guest-call-fast-entry-feasibility.md, docs/research/20260526-045000-guest-call-callee-aware-audit.md, docs/research/20260526-051000-a64-guest-call-fast-entry-target-rows.md, docs/research/20260526-053600-a64-guest-call-fast-entry-target-row-capture.md, docs/research/20260526-054200-82281d28-hot-block-codegen-floor.md, and docs/research/20260526-055500-guest-stack-arg-handoff-audit-skeleton.md. Use them as the active plan if present.",
        "Closed lanes: do not repeat f1/edge-payload behavior, stvewx, three-PC MUL_ADD_V128, fpscr, pre/post-promotion r1/r11, local-only 822824F0, broad Vulkan work, PACK/UNPACK VMX128 behavior, broad PERMUTE/LOAD_VECTOR_SHL/SHR behavior, unchanged HIR mapper captures, ordinal-fallback HIR behavior, local 82281D28:8228233C-82282370 store elision, one-off 826BF770 caller inlining, unchanged call/setup audits, unchanged 0x82281D28 fast-entry summary captures, unchanged 0x82281D28 fast-entry target-row captures, unchanged 82281D28 hot-block codegen-floor audits, any fast-entry patch that replaces A64Function::machine_code or the global indirection slot, and any fast-entry behavior patch without a source-level guarded-stub / late-bound-entry design. The edge-payload lifetime audit found segments_survived_no_kill=0 and f1_reads_before_kill=0. PACK/UNPACK route-volume found PACK absent and UNPACK zero weighted hot-block volume. The 20260526 VMX128 route counters found current vector volume either in closed local stvewx/vmaddfp shapes or smaller non-dominant 82287788 blocks. The 82281D28 call/setup audit found all r3-r10/lr stores live into callees and strict local promotion has zero safe wins. The target-row capture found broad offline live-in volume for 82281D28, with callee_first_load_stores=247 and body_weighted_live_in_fields=690421033, but behavior remains blocked because runtime target rows show unresolved_direct_targets=52, normal_entry_fallback=67, stackpoint_sensitive=67, dirty_flush_points=268, flush_context_barrier=260, and parent_pre_call_flush_points=195. The hot-block codegen-floor audit shows 82281D28:8228233C-82282370 is scalar guest-stack argument setup, not VMX/GPU work.",
        ...
        "Preferred next lanes are structural and currently ranked: FullDeploy plus a route-clean 0x82281D28 guest-stack argument handoff capture using -Arm64GuestStackArgHandoffAudit true -Arm64GuestStackArgHandoffAuditFunction 0x82281D28 -Arm64GuestStackArgHandoffAuditBudget 16 with delayed body-time comparators 82282490,82281D28,82287788, then parse with tools/thor/thor_hir_guest_call_arg_handoff_audit.ps1 -GuestStackArgHandoffAuditLogPath <new-speed-logcat>; guarded-stub / late-bound-entry design only if capture rows explicitly handle normal-entry fallback, global indirection, stackpoint/debug/exception visibility, and dirty flush points for top body-weighted call targets; fastmem/addressing counters if guest stack LOAD_OFFSET/STORE_OFFSET traffic remains the wall; guest-state cache only if it avoids closed r1/r11/f1/fpscr/barrier lanes; helper/block-linking only with a reusable static rule; GPU offload only when counters justify it. Do not run a quiet speed A/B from counter-only evidence. Large HIR captures should use file-backed output or adb -s c3ca0370 logcat -G 64M first. Do not use -AllowOrdinalFallback for behavior decisions.",
