...
switch ($Mode) {
    ...
    "EnableBlueDragonFullSpeed" {
        $prompt = (
            ...
            "Latest evidence: docs/research/20260524-014050-word-loop-preset-rebaseline.md. The Blue Dragon speed preset now sends arm64_blue_dragon_word_copy_loop_fastpath=true by default and capture scratch/thor-debug/20260524-013649-* reached the visible opening sky/wing route with clean fatal-marker search. Final body-time moved the main wall back to the 82282490 opening-scene cluster: 82282490=25383515, 82281D28=7175068, 82490030=3480696, 82486178=1358411, 82485DD8=618538, and 82486018=457433. " +
            "Previous word-loop confirmation remains docs/research/20260524-013145-82485dd8-word-loop-quiet-ab.md: quiet same-APK fastpath-off scratch/thor-debug/20260524-012352-* had 82490030=3923146 and 82485DD8=1010794, while fastpath-on scratch/thor-debug/20260524-012713-* had 82490030=3573598 and 82485DD8=774505. The backend cvar remains globally default-off, but the Blue Dragon speed pack enables it unless an explicit control passes false. " +
            ...
            "Next slice should run delayed 82282490 block body-time under the current preset. If the old 822825E0 -> 82282490 recursive wall still dominates, use call-edge/HIR callee analysis there. Keep call-edge/profiling cvars default-off outside targeted captures."
        )
