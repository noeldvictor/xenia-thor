...
function New-BlueDragonFullSpeedPrompt {
    $parts = @(
        ...
        "Current decision notes: docs/research/20260525-203000-continual-harness-plan-reset.md, docs/research/20260525-203900-a64-mature-gap-reset-rerank.md, docs/research/20260526-012000-vmx128-route-stabilized-counters.md, docs/research/20260526-030200-82281d28-block-map-capture.md, docs/research/20260526-032000-82281d28-call-setup-audit.md, docs/research/20260526-053600-a64-guest-call-fast-entry-target-row-capture.md, docs/research/20260526-061637-guest-stack-arg-handoff-capture.md, docs/research/20260526-075500-a64-offset-address-fastpath-quiet-ab.md, docs/research/20260526-081300-82282490-82287788-codegen-floor-capture.md, docs/research/20260526-083000-a64-no-wrap-memory-eligibility-audit.md, docs/research/20260526-084500-a64-guarded-stub-entry-design.md, docs/research/20260526-085500-a64-nonclosed-guest-state-cache-audit.md, docs/research/20260526-090500-a64-nonclosed-gpr-cache-audit-skeleton.md, and docs/research/20260526-092500-a64-nonclosed-gpr-cache-capture.md. Use them as the active plan if present.",
        "Closed lanes: do not repeat f1/edge-payload behavior, stvewx, three-PC MUL_ADD_V128, fpscr, pre/post-promotion r1/r11, local-only 822824F0, broad Vulkan work, PACK/UNPACK VMX128 behavior, broad PERMUTE/LOAD_VECTOR_SHL/SHR behavior, unchanged HIR mapper captures, ordinal-fallback HIR behavior, local 82281D28:8228233C-82282370 store elision, one-off 826BF770 caller inlining, unchanged call/setup audits, unchanged 0x82281D28 fast-entry summary captures, unchanged 0x82281D28 fast-entry target-row captures, unchanged 82281D28 hot-block codegen-floor audits, unchanged guest-stack argument handoff captures, unchanged 82281D28 load/store offset audits, unchanged memory-lowering feasibility audits, unchanged offset-helper source audits, unchanged offset-helper route-safety captures, unchanged offset-helper quiet A/B captures, unchanged 82282490/82287788 codegen-floor captures, unchanged guarded-stub source audits, current fastmem/addressing behavior without a new no-wrap proof surface, any fast-entry patch that replaces A64Function::machine_code or the global indirection slot, and any fast-entry behavior patch before separate fast-entry storage plus a dirty-flush payload ABI exists. The edge-payload lifetime audit found segments_survived_no_kill=0 and f1_reads_before_kill=0. PACK/UNPACK route-volume found PACK absent and UNPACK zero weighted hot-block volume. The 82281D28 call/setup audit found all r3-r10/lr stores live into callees and strict local promotion has zero safe wins. The offset helper is route-clean and locally positive, but the no-wrap audit closes further host-pointer/immediate behavior for now. The guarded-stub audit confirms fast-entry is blocked by missing alternate-entry storage/payload ABI plus unresolved/fallback/stackpoint/dirty-flush blockers.",
        ...
        "Preferred next lanes are structural and currently ranked: use -Arm64OffsetMemoryAddressFastpath true explicitly in future Blue Dragon speed captures, but move away from fastmem/addressing unless the slice explicitly adds a no-wrap range counter or static range analysis. Current non-closed post-promotion GPR cache behavior is closed: the route-clean 0x82281D28 audit had candidate_loads=181 and candidate_stores=75 but clean_hits_possible=0, dirty_hits_possible=0, normal_fallback=256, peak_live_slots=5, estimated_spill_pressure=3, and high boundary pressure. Do not rerun unchanged nonclosed-cache captures for 0x82282490 or 0x82287788. Before another risky Thor run, run tools/thor/thor_continual_harness_review.ps1 -Mode Window and write/update a concise rerank note if the next structural lane is not already obvious. Guarded-stub / late-bound-entry only if the slice explicitly adds separate fast-entry storage and payload/dirty-flush contracts with generated behavior unchanged; helper/block-linking only with a reusable static rule; GPU offload only when counters justify it. Do not rerun the offset-helper A/B, unchanged 82282490/82287788 codegen-floor capture, current no-wrap eligibility audit, unchanged guarded-stub source audit, unchanged nonclosed guest-state ranking audit, unchanged nonclosed GPR cache skeleton work, or unchanged nonclosed GPR route capture, and only claim full speed with the full-speed proof marker criteria. Large HIR captures should use file-backed output or adb -s c3ca0370 logcat -G 64M first. Do not use -AllowOrdinalFallback for behavior decisions.",
