...
function New-BlueDragonFullSpeedPrompt {
    $parts = @(
        ...
        "Current decision notes: docs/research/20260525-203000-continual-harness-plan-reset.md, docs/research/20260525-203900-a64-mature-gap-reset-rerank.md, docs/research/20260525-233000-vmx128-route-volume-audit.md, and docs/research/20260526-001500-a64-register-allocation-audit-capture.md. Use them as the active plan if present.",
        ...
        "Preferred next lanes are structural and currently ranked: helper ABI/block-linking audit for the 82282490/82281D28/82287788 wall cluster, current PERMUTE/LOAD_VECTOR_SHL/SHR route counters before VMX128 behavior, guest-state cache design only if it avoids closed r1/r11/f1/fpscr/barrier lanes, fastmem only with counter evidence, and GPU offload only when counters justify it. The 0x82282490 register-allocation audit found no allocator spill pressure: blocks_with_spills=0, local_slots_added=0, and INT/FLOAT/VEC spill_requests=0.",
