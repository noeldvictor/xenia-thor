...
switch ($Mode) {
    ...
    "EnableBlueDragonFullSpeed" {
        $prompt = (
            ...
            "Do not start the 822824F0 stvewx peephole from stale entry-count evidence. The call-path audit docs/research/20260522-173542-82282490-call-path-audit.md shows the charged wall is inclusive call work: 822825E0 -> 0x82282490 charged_body_total=34726883, and 822825C8 -> 0x8227FEE8 charged_body_total=3216407. The targeted 8227FEE8 dump attempt scratch/thor-debug/20260522-172738-* idled before the route and emitted no callee dump. Next leave a default-off direct-call edge/body profiler for those two edges, or a control-sandwiched 8227FEE8 callee capture after proving the route is stable."
        )
