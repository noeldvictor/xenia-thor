...
switch ($Mode) {
    ...
    "EnableBlueDragonFullSpeed" {
        $prompt = (
            ...
            "Latest evidence: docs/research/20260524-013145-82485dd8-word-loop-quiet-ab.md. The arm64_blue_dragon_word_copy_loop_fastpath experiment for 82485DD8:82485E70 is now confirmed for the Blue Dragon Thor speed preset: quiet same-APK fastpath-off scratch/thor-debug/20260524-012352-* had 82490030=3923146 and 82485DD8=1010794, while fastpath-on scratch/thor-debug/20260524-012713-* had 82490030=3573598 and 82485DD8=774505, with matching visible opening screenshots and clean fatal-marker searches. The backend cvar remains globally default-off, but the Blue Dragon speed pack may enable it by default. " +
            ...
            "Next slice should run a fresh delayed body-time rebaseline with the Blue Dragon speed preset on. If 82490030 remains hot, re-split its children under the new preset; otherwise move back to the larger 82282490 opening-scene wall. Keep call-edge/profiling cvars default-off outside targeted captures."
        )
