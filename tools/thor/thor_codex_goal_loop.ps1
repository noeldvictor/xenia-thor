...
switch ($Mode) {
    ...
    "EnableBlueDragonFullSpeed" {
        $prompt = (
            ...
            "Latest evidence: docs/research/20260524-032005-82282490-dynamic-block-slice-report.md. The new tools/thor/thor_hir_dynamic_block_slice_report.ps1 maps body-backed local 82282490 spans. The top local target is 8228252C-822825C4: body total 8530471, edge body 5653971, approximate exclusive 2876500, and vector/FPR/state traffic with vspltw:6, lvx128:4, stvewx:3, vmaddfp:3, store_context:27, load_context:14, extract:9, and splat:6. Next run an A64 generated-code audit for this exact slice before implementing a default-off function/block-gated vector/store or state-traffic experiment. Previous recursive-edge evidence remains docs/research/20260524-031017-82282490-exclusive-callee-attribution.md: direct-call edges account for 84.08% of final 82282490 body ticks, and 822825E0 -> 82282490 is mostly callee-body work, not generic call/prolog overhead. Previous entry/exit evidence remains docs/research/20260524-025544-a64-entry-exit-profiler.md: generated prolog/epilog/stackpoint overhead is tiny, so keep a64_enable_host_guest_stack_synchronization default true and treat stack-sync-off as code-size evidence only. " +
