...
function New-BlueDragonFullSpeedPrompt {
    $parts = @(
        ...
        "Current decision notes: docs/research/20260526-075500-a64-offset-address-fastpath-quiet-ab.md, docs/research/20260526-083000-a64-no-wrap-memory-eligibility-audit.md, docs/research/20260526-084500-a64-guarded-stub-entry-design.md, docs/research/20260526-092500-a64-nonclosed-gpr-cache-capture.md, and docs/research/20260526-093500-a64-fast-entry-data-model-rerank.md. Use them as the active plan if present.",
