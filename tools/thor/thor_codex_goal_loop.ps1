...
switch ($Mode) {
    ...
    "EnableBlueDragonFullSpeed" {
        $prompt = (
            ...
            "Do not start the 822824F0 stvewx peephole from stale entry-count evidence. Next leave an offline/capture-backed audit of the 822825E0 recursive bl 0x82282490 path and the 822825C8 -> 0x8227FEE8 callee path, or a committed default-off experiment justified by that audit."
        )
