...
function New-BlueDragonFullSpeedPrompt {
    $parts = @(
        ...
        "Current reset note: docs/research/20260525-203000-continual-harness-plan-reset.md. Use it as the active plan if present.",
        ...
        "Preferred next lanes are structural: A64 backend maturity, guest-state/register allocation, helper ABI, block linking, fastmem/addressing, broad VMX128-to-NEON lowering, hybrid/static hot-function design with normal fallback, or measured GPU bulk-work offload only when counters justify it.",
