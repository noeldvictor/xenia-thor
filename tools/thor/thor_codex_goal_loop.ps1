...
switch ($Mode) {
    ...
    "EnableBlueDragonFullSpeed" {
        $prompt = (
            ...
            "Do not start the 822824F0 stvewx peephole from stale entry-count evidence. The call-path audit docs/research/20260522-173542-82282490-call-path-audit.md shows the charged wall is inclusive call work: 822825E0 -> 0x82282490 charged_body_total=34726883, and 822825C8 -> 0x8227FEE8 charged_body_total=3216407. The call-edge audit-only follow-up docs/research/20260522-190502-call-edge-audit-only-and-edge-proof.md proves dynamic edge rows when delayed 82282490 body-time stabilizes the route: 822825E0 -> 82282490 dominates body_ticks_total=21299726 peak=7315115, followed by 822825C8 -> 8227FEE8 body_ticks_total=4515376 peak=1933191. Focused 8227FEE8 note docs/research/20260522-193049-8227fee8-focused-capture.md measured route-clean 8227FEE8 body_ticks_total=3650429 peak=1408271 peak_tpe=738 code_size=49804 in scratch/thor-debug/20260522-191427-*. Filtered dumps now log at warning level and Thor metadata records disassemble_function_filter, but the first patched filtered run scratch/thor-debug/20260522-192429-* and patched no-filter control docs/research/20260522-230909-patched-route-control-black-idle.md / scratch/thor-debug/20260522-230518-* black-idled before route. Idle owner attribution and patched route recheck docs/research/20260522-232945-a64-idle-owner-attribution.md added owner_hint native-TID mapping for busy processor debug-lock snapshots, then scratch/thor-debug/20260522-232133-* reached the visible opening route with no searched fatal markers and APK SHA E92DAC2CB4E7080C196DB9656305F372DC20C189E7697A2FCCD47D1E12DA3FA3. Next run a control-sandwiched filtered 8227FEE8 capture with delayed body-time route stabilizer; if route-clean, use the warning-level HIR dump for focused codegen audit; if it black-idles, inspect owner_hint before changing guest behavior."
        )
