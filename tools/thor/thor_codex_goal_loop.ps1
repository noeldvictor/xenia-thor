...
switch ($Mode) {
    ...
    "EnableBlueDragonFullSpeed" {
        $prompt = (
            ...
            "Latest MUL_ADD_V128 runtime-audit capture: docs/research/20260524-080156-blue-dragon-mul-add-v128-audit-capture.md. The first deployed capture reached the visible opening route but emitted no audit rows because Android did not forward arm64_blue_dragon_mul_add_v128_audit into native launch cvars; EmulatorActivity.java now copies that extra. Rerun scratch/thor-debug/20260524-075713-* reached visible opening sky/dragon-wing with clean fatal-marker search on APK SHA 7BBAB603A9931918867E9AAE0869193F3A2049329ED7FB448D36C4E66B97EE85. Final counters for 82282490 PCs 82282568, 8228256C, and 82282570 were hot but semantically quiet: total=722256/2131533, each PC=240752/710511, fpcr_switch=240752/710511, sw_flush_path=0/0, input_denorm=0/0, output_denorm=0/0, nan_entry=0/0, and nan_lane=0/0. Next continuation should implement one default-off Blue-Dragon/function/PC-gated MUL_ADD_V128 fastpath for only those three PCs, then prove route safety before a quiet same-APK A/B. Keep audit and fastpath out of presets until speed is proven. " +
