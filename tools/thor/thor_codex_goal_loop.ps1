...
switch ($Mode) {
    ...
    "EnableBlueDragonFullSpeed" {
        $prompt = (
            ...
            "Current priority, superseding all older chronology below: docs/research/20260525-195600-edge-payload-lifetime-audit.md records the default-off, counter-only edge payload lifetime audit for exact edge 82282490:82282598 -> 82287788. Capture scratch/thor-debug/20260525-195142-* used APK SHA F19476F6E279449C5F155045F0662124941BACD66F60BC05809BF95D304BB72E, reached visible opening sky / dragon-wing, and had a clean fatal-marker search. Behavior stayed unchanged: payload_materializations_allowed=0, behavior_changed=0, normal-entry fallback preserved, and no payload state was materialized. Final observed lifetime counters block the current payload-storage speed patch: segments_started=698767, segments_survived_no_kill=0, f1_reads_before_kill=0, f1_reads_after_kill=2085964, r3_reads_before_kill=0, r3_reads_after_kill=1426326, r3_writes_before_kill=0, r3_writes_after_kill=2086964, and first_context_barrier=698767; all other first-kill reasons were zero. Final body-time remains CPU/JIT-heavy: 82282490=39940278, 82281D28=8099644, 82287788=6069873, Main Thread 96.1%, GPU Commands 11.5%. Do not materialize edge payload state and do not run a quiet speed A/B from this lane. Next useful slice is an offline HIR/source audit of the first CONTEXT_BARRIER in 82287788, including exact guest PC and surrounding state traffic, to decide whether the barrier can safely preserve read-only f[1] or blocks this payload-storage strategy. " +
            "Freshest priority, superseding the older chronology below: docs/research/20260525-193245-edge-payload-storage-audit-capture.md records the default-off, counter-only arm64_blue_dragon_edge_payload_storage_audit skeleton plus FullDeploy and route-clean Thor proof for exact edge 82282490:82282598 -> 82287788. Capture scratch/thor-debug/20260525-192928-* used APK SHA 9DD345DCD8C404E0BDE50D3C67F72EF1CA105A2C9A4A3F7554462EF17BA567DF, reached visible opening sky / dragon-wing, and had a clean fatal-marker search. Behavior stayed unchanged: payload_materializations_allowed=0, behavior_changed=0, normal-entry fallback preserved, no normal machine-code replacement, and no global indirection-slot change. Final counters show useful edge volume but high lifetime pressure: eligible_edge_calls=910159, normal_entry_fallbacks=910159, indirection_fallbacks=910159, f1_active_reads_covered=2717039, f1_unknown_kills=0, fpscr_dirty_writes=2849260, fpscr_required_writebacks=922692, r3_mutable_writes=2718234, context_barrier=11561589, external_visibility=48803, and unknown_call=0. Final body-time remains CPU/JIT-heavy: 82282490=51783317, 82281D28=10283586, 82287788=6836225, Main Thread 103%, GPU Commands 11.5%. Do not materialize payload state or run a quiet speed A/B from this first audit. Next useful slice is a counter-only payload lifetime/segment audit for the same edge, measuring usable f[1] / r[3] reads before the first context barrier, external visibility point, return/exit, or required fpscr writeback. Keep fpscr in the separate CFG-writeback lane, r[3] count-only until lifetime is proven, and lr on the normal PPC call/return path. " +
            "Previous priority: docs/research/20260525-190544-edge-payload-storage-design.md and tools/thor/thor_a64_edge_payload_storage_design.ps1 convert the route-clean f[1] kill taxonomy into the next implementation contract. The missing piece was a default-off counter-only arm64_blue_dragon_edge_payload_storage_audit skeleton for exact edge 82282490:82282598 -> 82287788. First proof must keep payload_materializations_allowed=0, behavior_changed=0, normal-entry fallback preserved, no A64Function::machine_code replacement, and no global indirection-slot change. Count f[1] as the first payload candidate, keep fpscr in the separate CFG-writeback lane, keep r[3] count-only until the f[1]/fpscr shape is proven, and leave lr on the normal PPC call/return path. Do not run a quiet speed A/B or materialize payload state until route-clean Thor counter rows prove useful hit volume and manageable flush pressure. " +
            "Current priority, superseding the older chronology below: docs/research/20260525-184957-edge-f1-kill-taxonomy.md records a FullDeploy plus route-clean Thor capture for default-off arm64_blue_dragon_edge_variant_audit taxonomy counters. Working tree based on commit 8d053566e, APK SHA DEDD20333729C3E6B44CC1E423357147F0A9149D034C6D0A2DB0237AB8BF5C61, reached the visible opening sky / dragon-wing route with clean fatal-marker search. Exact edge 82282490:82282598 -> 82287788 remains behavior-neutral with eligible_calls=710511, normal_fallbacks=710511, payload_materializations=0, active_f1_reads=2121019, and active_call_kills=1781437. Taxonomy counters were helper_preserved_calls=720290, child_preserved_calls=350636, return_exit_calls=710511, and unknown_call_kills=0. Active f[1] read sites were 82287798=710511, 82287828=350636, 82287CF8=350031, 82287D10=350031, 82287D8C=350031, 82287F1C=9779, and 82287A1C/82287A2C/82287AA4/82287EA8=0. Active kill sites were 8228778C=710511, 82287854=350636, 82287ED4=0, 82287EDC=700732, 82287EE4=9779, and 82288220=9779. Do not materialize an f[1]-only payload or run a quiet speed A/B from this audit-only patch. Next useful slice is broader caller-local or side-table edge payload-storage design for the same edge, using the zero-unknown-kill result while keeping fpscr in the separate CFG-writeback lane. Final evidence remains CPU/JIT-heavy: 82282490=39738917, 82281D28=8067997, 82287788=4878256, Main Thread 103%, GPU Commands 7.6%; do not pivot to broad Vulkan work. Hardware acceleration menu docs/research/20260525-171305-thor-hardware-acceleration-menu.md says use Thor NEON/dot/I8MM/CRC/LSE only with opcode/source/counter proof and move only Xenos-like bulk graphics work to Adreno after a measured graphics-work audit finds CPU-side graphics cost. " +
