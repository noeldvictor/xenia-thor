...
DECLARE_bool(gpu_vulkan_shader_stats);
DECLARE_uint32(gpu_edram_atomic_barrier_bytes);
DECLARE_bool(gpu_vulkan_hybrid_postprocess);
...
DECLARE_bool(gpu_diag_raster_ab);
...
DECLARE_int32(guest_watch_ms);
DECLARE_string(guest_watch_addrs);
DECLARE_string(guest_watch_ptrs);
DECLARE_int32(guest_watch_budget);
...
DECLARE_bool(gpu_dynamic_polygon_mode);
DECLARE_bool(gpu_dynamic_depth_clamp);
